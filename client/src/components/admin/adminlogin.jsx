	...
	const handleLogin = () => {
		adminSchema
			...
			.then(() => {
				...
				axios
					.post(process.env.REACT_APP_DEV_API_URL + "/auth/login", {
						email,
						password,
						role: "Administrator",
					})
				...
				{!isLoading && (
					<>
						{!showOtp && (
							<div id='signin'>
								<Box p={3}>
									<Typography variant='h5'> Administrator Login</Typography> <br />
									<TextField
										size='small'
										required
										fullWidth
						...
						{showOtp && (
							<div id='otp'>
								<Box p={3}>
									...
									<Typography variant='body2'>Please enter OTP to complete verification</Typography>
									<br />
									<TextField
										required
										fullWidth
									...
									<Button disabled={!otp} fullWidth variant='contained' color='secondary' onClick={handleVerifyLogin}>
										continue
									</Button>
								</Box>
							</div>
